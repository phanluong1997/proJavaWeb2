 ...
 * @author Admin
 */
public class GiayAdd2Servlet extends HttpServlet {
...
"            <section>");
            ...
            out.println("<h2>Kết quả thêm mới</h2>");
            ...
            if (dao.Create(s)) {
                out.println("Thêm mới thành công!");
            } else {
                out.println("Có lỗi xảy ra! Thêm mới không thành công!");
            }

 ...
 * @author Admin
 */
public class LoaiGiaySearch2Servlet extends HttpServlet {
...
"            </aside>\n" +
"            <section>");
            out.println("<h2>KẾT QUẢ Tìm kiếm giày trong cửa hàng </h2>");
            
            
            DAOloaigiay dao = new DAOloaigiay();
            String tenloai = request.getParameter("tenloai");
//            out.println(""+tenloai);
//            loaigiay s = new loaigiay( tenloai);
//                    
            dao.Select(tenloai);
            ArrayList<loaigiay> list = dao.getList();
//           out.println("sao"+list);
//            int size = list.size(); 
//             out.println("ầlkfj"+size);

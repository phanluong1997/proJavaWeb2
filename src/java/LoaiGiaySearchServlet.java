 ...
 * @author Admin
 */
public class LoaiGiaySearchServlet extends HttpServlet {
...
"            </aside>\n" +
"            <section>");
            out.println("<h2>Tìm kiếm giày trong cửa hàng </h2>");
         
            
            out.println("<form action='LoaiGiaySearch2Servlet' method='post'>");
            out.println("<table>");
            
            out.println("<tr>");
            out.println("<td>Nhập nội dung giày cần tìm :</td>");
            out.println("<td>");
            out.println("<input type='text' name='tenloai' required>");
             out.println("</td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td colspan='2'><button type='submit' value=''>Tìm kiếm</button></td>");
            out.println("</tr>");

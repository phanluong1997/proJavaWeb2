 ...
 * @author Admin
 */
public class LoaiGiayAddServlet extends HttpServlet {
...
"            </aside>\n" +
"            <section>");
            out.println("<h2>Thêm mới Danh mục các Loại giày bán tại Shop </h2>");
            out.println("<form action='LoaiGiayAdd2Servlet' method='post'>");       
            out.println("<table>");
            
            out.println("<tr>");
            out.println("<td>IDLoạiGiày:</td>");
            out.println("<td><input type='text' name='idloaigiay' id='idloaigiay' required></td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td><label for='tenloai'>tên Loại giày</label></td>");
            out.println("<td><input type='text' name='tenloai' id='tenloai' required ></td>");
            out.println("</tr>");

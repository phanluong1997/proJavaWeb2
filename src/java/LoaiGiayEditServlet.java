 ...
 * @author Admin
 */
public class LoaiGiayEditServlet extends HttpServlet {
...
"            <section>");
            ...
            out.println("<form action='LoaiGiayEdit2Servlet' method='post'>");
            out.println("<table>");
            out.println("<tr>");
            out.println("<td><label for='idloaigiay'>IDLoai Giày</label></td>");

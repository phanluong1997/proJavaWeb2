 ...
 * @author Admin
 */
public class GiayEdit2Servlet extends HttpServlet {
...
"            </aside>\n" +
"            <section>");
            out.println("<h2>Kết quả chỉnh sửa thông tin giày</h2>");
            
            DAOgiay dao = new DAOgiay();
            
            int idgiay = Integer.parseInt(request.getParameter("id"));
           // out.println("" +idgiay);
            String tengiay = request.getParameter("tengiay");
            out.println("" +tengiay);
            String hinhanh = request.getParameter("hinhanh");
            int gia = Integer.parseInt(request.getParameter("gia"));
            int idloaigiay = Integer.parseInt(request.getParameter("idloaigiay"));
            
            giay s = new giay(idgiay, tengiay, hinhanh, gia, idloaigiay);
            
            if (dao.Update(s)) {
                out.println("Cập nhật thành công!");
            } else {
                out.println("Có lỗi xảy ra! Cập nhật không thành công.");
            }
            
            out.println("<button onclick=\"location.href='GiayListServlet'\";'>Quay lại</button>");

 ...
 * @author Admin
 */
public class GiayAddServlet extends HttpServlet {
...
"            </aside>\n" +
"            <section>");
            out.println("<h2>Thêm mới giày bán chạy </h2>");
            
            out.println("<form action='GiayAdd2Servlet' method='post'>");
            
            out.println("<table>");
            out.println("<tr>");
            out.println("<td>ID Giày:</td>");
            out.println("<td><input type='text' name='idgiay' id='idgiay' required></td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td><label for='tengiay'>tên giày</label></td>");
            out.println("<td><input type='text' name='tengiay' id='tengiay' required ></td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td><label for='hinhanh'>Hình Ảnh</label></td>");
            out.println("<td><input type='text' name='hinhanh' id='hinhanh' required></td>");
            out.println("</tr>");
            
            
            out.println("<tr>");
            out.println("<td><label for='gia'>Giá</label></td>");
            out.println("<td><input type='text' name='gia' id='gia' ></td>");
            out.println("</tr>");
            
            out.println("<tr>");
            out.println("<td><label for='idloaigiay'>ID Loại Giày</label></td>");
            out.println("<td><input type='text' name='idloaigiay' id='idloaigiay' ></td>");
            out.println("</tr>");
            
            
            
            out.println("<tr>");
            out.println("<td colspan='2'><button type='submit'>Thêm mới</button></td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</form>");
